...
class UserDetailsCubit extends Cubit<UserDetailsState> {
  ...
  Future<void> isDailyAdsAvailable() async {
    isDailyAdAvailable =
        await _profileManagementRepository.isDailyAdsAvailable();
  }

  Future<bool> watchedDailyAd() async {
    return await _profileManagementRepository.watchedDailyAd();
  }
