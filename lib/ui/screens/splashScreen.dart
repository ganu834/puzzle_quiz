...
class _SplashScreenState extends State<SplashScreen>
  ...
  // svgs and image supported.
  final _appLogo = UiUtils.getImagePath("splash_logo.svg");
  final _companyLogo = UiUtils.getImagePath("wrteam_logo.svg");
      ...
      children: [
        AnimatedBuilder(
          ...
          child: Container(
            ...
            child: Center(
              child: _appLogo.endsWith('.svg')
                  ? SvgPicture.asset(
                      _appLogo,
                      color: Theme.of(context).colorScheme.background,
                    )
                  : Image.asset(_appLogo),
            ),
          ),
        ),
        Align(
          ...
          child: Padding(
            ...
            child: _companyLogo.endsWith('.svg')
                ? SvgPicture.asset(_companyLogo)
                : Image.asset(_companyLogo),
          ),
        ),
      ],
    );
