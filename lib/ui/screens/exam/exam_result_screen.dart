            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "${AppLocalization.of(context)!.getTranslatedValues("obtainedMarks")!} : ${examResult.obtainedMarks()}/${examResult.totalMarks}",
                    style: TextStyle(
                      fontSize: 16,
                  ...
                  children: [
                    Text(
                      AppLocalization.of(context)!
                          .getTranslatedValues("totalQuestions")!,
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeights.medium,
                        color: colorScheme.onTertiary,
                    ...
                    Text(
                      "[ ${examResult.totalQuestions()} ${AppLocalization.of(context)!.getTranslatedValues("quesLbl")!}]",
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeights.medium,
                        color: colorScheme.onTertiary,
                          ...
                          children: [
                            ...
                            TextSpan(
                              text: AppLocalization.of(context)!
                                  .getTranslatedValues("correctAnswersLbl")!,
                      ...
                      Text.rich(
                        TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text: AppLocalization.of(context)!
                                  .getTranslatedValues("incorrectAnswersLbl")!,
                              style: const TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeights.regular,
                              ),
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                "$marks ${AppLocalization.of(context)!.getTranslatedValues("markQuestionsLbl")!}",
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeights.medium,
                  color: textColor,
              ...
              Text(
                "[ $totalQues ${AppLocalization.of(context)!.getTranslatedValues("quesLbl")!} ]",
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeights.medium,
                  color: textColor,
